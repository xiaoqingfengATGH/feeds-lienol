...
---- Whitelist Hosts
s:tab("w_hosts", translate("Whitelist Hosts"), "<font>" ..
...
---- Whitelist IP
s:tab("w_ip", translate("Whitelist IP"), "<font>" .. translate(
...
---- Blacklist IP
s:tab("b_ip", translate("Blacklist IP"), "<font>" .. translate(
...
-- [[ ACLs Settings ]]--
s = m:section(TypedSection, "acl_rule", translate("ACLs"), "<font>" .. translate(
